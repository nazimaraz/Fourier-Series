...
namespace UI
{
    ...
    public:
        ...
        [[nodiscard]] auto get_wave() -> boost::circular_buffer<float>&;
        auto set_path_capacity(boost::circular_buffer<Vector2>::capacity_type capacity) -> void;
        [[nodiscard]] auto get_path() -> boost::circular_buffer<Vector2>&;
